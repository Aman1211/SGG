...
function admin_del()
{
window.open("../web/index.php", "_self", "toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=400,height=400");
}
function admin_rec()
{
...
<div class="input-group">
                        ...
                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" type="submit" name="back">Back</button>
                        </div>
                    </form>
                </div>
            </div>
...
WHERE USER_NAME like '$name1'";
	...
	if(isset($_POST['delete']))
	{
        ...
        if($num==-1)
                {
                    echo "<script> alert('Cannot Delete this Account'); </script>";
                    echo "<script> location.href='../web/index.php' </script>";
