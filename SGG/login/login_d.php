            ...
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="password" placeholder="Password" name="psw" id="pwd" class="masked" style="width:210px" required="">
...
{	
 ...
 $_SESSION['typeid']=1;     
$id1=$_GET['p_id'];
echo "<script> location.href='../web/single.php?id=$id1' </script>";
