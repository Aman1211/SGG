            ...
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Firstname" name="fname" required>
                        </div>
						<div class="input-group">
						...
						<div class="input-group">
						 <textarea name="add" class="input--style-3" rows="5" cols="25" onfocus="msg2()"required placeholder="Address" ></textarea>
                          ...
                          <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Enter Nickname" name="nname" required>
                        </div>
						 <div class="input-group">
...
if($cat_id==1)
{
$query="INSERT INTO login(USER_NAME,USER_PASSWORD,user_category_id,User_Email_id,USER_ADDRESS,contact_no,FirstName,LastName,Area_id,SEQURITY_ANSWER)VALUES('$username',ENCODE('$password','secret'),1,'$email','$add',$contact,'$fname','$lname',$c_id,'$nname')";
