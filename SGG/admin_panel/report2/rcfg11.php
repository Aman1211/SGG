...
define("EWR_PROJECT_ID", "{F08CCDDC-FAC2-4A5E-8448-7129975FD6F3}", TRUE); // Project ID
...
define("EWR_IS_PHP5", version_compare(PHP_VERSION, "5.5.0") >= 0, TRUE); // Is PHP 5.5 or later
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "sgg1", "qs" => "`", "qe" => "`");
$EWR_CONN[0] = &$EWR_CONN["DB"];
$EWR_CONN["sgg11"] = array("conn" => NULL, "id" => "sgg11", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "sgg1", "qs" => "`", "qe" => "`", "new" => TRUE);
$EWR_CONN[1] = &$EWR_CONN["sgg11"];
...
define("EWR_RANDOM_KEY", 'tlBreY6Bl3txjIsz', TRUE); // Random key for encryption
