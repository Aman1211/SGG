...
<script type="text/javascript">
	$(document).ready(function(){
		$('#name').keyup(function(){
				...
				$.post("./view/check_city.php",{brand_name: brand_check},function(data)
				{
					if(data.status == true)
					{
...
<hr>
    ...
    <input type="text" placeholder="Enter the city name" name="b_name" id="name" required value="<?php echo $Brand_name;?>" onkeypress="return (event.charCode>64 && event.charCode<91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)"/><br>
