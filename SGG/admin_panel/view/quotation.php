...
$this->setfont('Arial','B',12);
			...
			require'../db.php';
				...
				while($row3=mysqli_fetch_array($result3))
				{
					...
					$sql6="select  FirstName,LastName,Area_id,User_Email_id from login where USER_ID='$u_id'";
				...
				function abc()
				{
					...
					$id3=get();
					require '../db.php';
					$sql8="select User_id from request where Request_id='$id3'";
					...
					$email="";
						$sql7="select User_Email_id from login where USER_ID='$u_id'";
						$result7=mysqli_query($conn,$sql7);
							while($row7=mysqli_fetch_array($result7))
							{
									$email=$row7['User_Email_id'];
							}
							return $email;
				}
