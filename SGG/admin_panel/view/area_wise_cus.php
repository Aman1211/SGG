...
$data = array(
	...
	class mypdf extends fpdf
	{
		...
		function headertable()
		{
			...
			$d=date('d/m/Y');
			$this->Cell(170,10,' AREA-WISE CUSTOMER REPORT',1,0,'C');
			...
			$this->Cell(175,10,'CUSTOMER NAME',1,0,'C');
		...
		function viewtable()
		{
			...
			$f_id="";$i=1;
				...
				$feed= "SELECT  * from `login` WHERE `Area_id` in(select Area_id from area where Area_name='$id') and user_category_id=2";
				...
				if($feedrun)
				{
					...
					{
								$f_id=$feedrow['FirstName'];
								$s_id=$feedrow['LastName'];
						...
						$this->Cell(175,10,$f_id." ".$s_id,1,0,'C');
