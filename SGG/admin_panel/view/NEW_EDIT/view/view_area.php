  ...
  <table id="data">
	...
	if($queryresult>0){
		while($row=mysqli_fetch_assoc($result)){		
					...
					<td>".$row['Pincode']."</td>
					<td>".$id2."</td>"; ?>
			<td><a href="javascript:if(confirm('Are you want to Update this record?')) {location.href='./view/edit_area.php?edit_a=<?php echo $id ?>'}">EDIT</a></td>
...
?>
     <tr align="center">
       ...
       <td><a href="javascript:if(confirm('Are you want to Update this record?')) {location.href='./EDIT/edit_area.php?edit_a=<?php echo $a_id ?>'}">EDIT</a></td>
