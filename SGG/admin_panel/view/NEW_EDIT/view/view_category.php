  ...
  <table id="data">
    ...
    while($row=mysqli_fetch_assoc($result)){
      ...
      $name=$row['Category_name'];
          ...
          <td><a href="javascript:if(confirm('Are you want to edit this record?')) {location.href='./EDIT/edit_category.php?edit_c=<?php echo $id ?>'}">EDIT</a></td>
...
<?php
     ...
     <tr align="center">
       ...
       <td><?php echo $b_NAME; ?></td>
        <td><a href="javascript:if(confirm('Are you sure, you want to edit this Record?')) {location.href='./EDIT/edit_category.php?edit_c=<?php echo $b_id; ?>'}">EDIT</a></td>
