      ...
      if (isset($_POST['submit'])){
        ...
        if($queryresult>0){
          while ($row=mysqli_fetch_assoc($result)) {
           ...
           <td><a href="javascript:if(confirm('Are you want to edit this record?')){location.href='./edit_company.php?&edit_c=<?php echo $id; ?>'}">EDIT</a></td>
        ...
        if($queryresult1>0){
          ...
          <!--<td><a href="javascript:if(confirm('Are you want to edit this record?')){location.href=?link=41&edit_c=<?php echo $id;?>}">EDIT</a></td>-->
           <td><a href="javascript:if(confirm('Are you want to edit this record?')){location.href='./edit_company.php?&edit_c=<?php echo $id1; ?>'}">EDIT</a></td>
...
?>
     <tr align="center">
      ...
      <!--<td><a href="javascript:if(confirm('Are you want to edit this record?')){location.href=?link=41&edit_c=<?php echo $id;?>}">EDIT</a></td>-->
      <td><a href="javascript:if(confirm('Are you want to edit this record?')){location.href='./edit_company.php?&edit_c=<?php echo $c_id; ?>'}">EDIT</a></td>
