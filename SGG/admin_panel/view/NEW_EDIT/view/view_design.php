	...
	if($queryresult>0){
		while($row=mysqli_fetch_assoc($result)){
			$id=$row['Design_id'];
					...
					<td>".$row['Price']."</td>
				"; ?>
            <td><a href="javascript:if(confirm('Are you sure do you want to delete this record?')){location.href='./edit_design.php?edit_design=<?php echo $id ?>'}">EDIT</a></td>
...
?>
     <tr align="center">
       ...
       <td><?php echo $price; ?></td>
        ...
        <td><a href="javascript:if(confirm('Are you sure do you want to delete this record?')){location.href='./edit_design.php?edit_design=<?php echo $d_id ?>'}">EDIT</a></td>
