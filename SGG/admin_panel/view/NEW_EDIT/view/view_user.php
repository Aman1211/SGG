...
<form action="" method="POST">
  ...
  if($queryresult>0){
    while($row=mysqli_fetch_assoc($result)){
        ...
        <td> ".$id2."</td>"
 ?>
  <td> <a href="javascript:if(confirm('Are you want to edit this record?')) {location.href='./EDIT/edit_user.php?edit_u=<?php echo $id;?>'}">EDIT </a></td>
        <td><a href="javascript:if(confirm('Are You Want to delete this record')) {location.href='./delete/delete_user.php?delete_u=<?php echo $id;?>'}">DELETE</a></td>
        </tr>
        <?php
           }
  }
  ...
  elseif($queryresult<1)
        ...
        <td>  ".$ln."</td>
        <td> ".$area_name."</td>"?>
          <td><a href="javascript:if(confirm('Are You Want to update this record')) {location.href='./EDIT/edit_user.php?edit_u=<?php echo $id;?>'}">EDIT</a></td>
         <td> <a href="javascript:if(confirm('Are you want to delete this record?')) {location.href='./delete/delete_user.php?delete_b=<?php echo $id;?>'}">DELETE </a></td>
...
?>
     <tr align="center">
       ...
       <td><?php echo $area_id; ?></td>
         ...
         <td><a href="javascript:if(confirm('Are You Want to update this record')) {location.href='./EDIT/edit_user.php?edit_u=<?php echo $u_id;?>'}">EDIT</a></td>
           <td> <a href="javascript:if(confirm('Are you want to delete this record?')) {location.href='./delete/delete_user.php?delete_u=<?php echo $u_id;?>'}">DELETE </a></td>
