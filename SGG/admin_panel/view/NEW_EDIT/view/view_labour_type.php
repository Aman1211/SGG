...
<div class="search-container">
  ...
  if($queryresult>0){
    while($row=mysqli_fetch_assoc($result)){
        ...
        <td> <a href="javascript:if(confirm('Are you want to edit this record?')) {location.href='./EDIT/edit_labour_type.php?edit_l=<?php echo $id;?>'}">EDIT </a>  
    ...
    echo "<script>alert ('No Result Found')</script>";
     ...
     <tr align="center">
       ...
       <td> <a href="javascript:if(confirm('Are you want to edit this record?')) {location.href='./EDIT/edit_labour_type.php?edit_l=<?php echo $l_id;?>'}">EDIT </a>  
