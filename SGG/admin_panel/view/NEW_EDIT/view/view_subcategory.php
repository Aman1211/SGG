      ...
      if(isset($_POST['submit']))
      {
        ...
        if($queryresult>0)
        {
          ...
          <tr align='center'>
           ...
           <td>".$id2."</td>
          " ?>
          <td><a href="javascript:if(confirm('Are you want to edit this record?')){location.href='./EDIT/edit_subcategory.php?edit_s=<?php echo $id; ?>'}">EDIT</a></td>
   ...
   elseif($queryresult<1)
        {
          ...
          <td>".$SB_name."</td>
          <td>".$l_name."</td>"?>
        <td><a href="javascript:if(confirm('Are you want to edit this record?')){location.href='./EDIT/edit_subcategory.php?edit_s=<?php echo $l_id; ?>'}">EDIT</a></td>
...
?>
     <tr align="center">
       ...
       <td><a href="javascript:if(confirm('Are you want to edit this record?')){location.href='./EDIT/edit_subcategory.php?edit_s=<?php echo $s_id; ?>'}">EDIT</a></td>
